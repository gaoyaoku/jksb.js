...
$.setdata('','username');
$.setdata('','password');
$.setdata('','provinceCode');
$.setdata('','cityCode');
$.setdata('','currentLocation');
$.setdata('','longitude');
$.setdata('','latitude');
$.setdata('','isPersistence')

console.log($.getdata('username'));
console.log($.getdata('password'));
console.log($.getdata('provinceCode'));
console.log($.getdata('cityCode'));
console.log($.getdata('currentLocation'));
console.log($.getdata('longitude'));
console.log($.getdata('latitude'));
console.log($.getdata('isPersistence'))
